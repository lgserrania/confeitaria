...
<div class="d-sm-flex align-items-center justify-content-between mg-b-20 mg-lg-b-30">
    ...
    <div class="d-none d-md-block">
        ...
        <button class="btn btn-sm pd-x-15 btn-primary btn-uppercase mg-l-5"><i data-feather="plus"
                class="wd-10 mg-r-5"></i> Add New Ticket</button>
    </div>
</div>
                ...
                <div class="row row-sm">
                    <div class="col-6 col-sm-4 col-md-3 col-lg">
                        ...
                        <div class="progress ht-2 mg-b-10">
                            <div class="progress-bar wd-100p bg-df-2" role="progressbar" aria-valuenow="100"
                                aria-valuemin="0" aria-valuemax="100"></div>
                        </div>
                        <h6 class="tx-uppercase tx-spacing-1 tx-semibold tx-10 tx-color-02 mg-b-2">New Tickets
                        </h6>
                        <p class="tx-10 tx-color-03 mg-b-0"><span class="tx-medium tx-success">1.2% <i
                                    class="icon ion-md-arrow-down"></i></span> than yesterday</p>
                    </div><!-- col -->
                    <div class="col-6 col-sm-4 col-md-3 col-lg">
                        <h4 class="tx-normal tx-rubik mg-b-10">86</h4>
                        <div class="progress ht-2 mg-b-10">
                            <div class="progress-bar wd-85p bg-df-2" role="progressbar" aria-valuenow="85"
                                aria-valuemin="0" aria-valuemax="100"></div>
                        </div>
                        <h6 class="tx-uppercase tx-spacing-1 tx-semibold tx-10 tx-color-02 mg-b-2">Solved
                            Tickets</h6>
                        <p class="tx-10 tx-color-03 mg-b-0"><span class="tx-medium tx-danger">-0.6% <i
                                    class="icon ion-md-arrow-down"></i></span> than yesterday</p>
                    </div><!-- col -->
                    <div class="col-6 col-sm-4 col-md-3 col-lg mg-t-20 mg-sm-t-0">
                        <h4 class="tx-normal tx-rubik mg-b-10">27</h4>
                        <div class="progress ht-2 mg-b-10">
                            <div class="progress-bar wd-25p bg-df-2" role="progressbar" aria-valuenow="25"
                                aria-valuemin="0" aria-valuemax="100"></div>
                        </div>
                        <h6 class="tx-uppercase tx-spacing-1 tx-semibold tx-10 tx-color-02 mg-b-2">Unresolved
                        </h6>
                        <p class="tx-10 tx-color-03 mg-b-0"><span class="tx-medium tx-success">0.3% <i
                                    class="icon ion-md-arrow-down"></i></span> than yesterday</p>
                    </div><!-- col -->
                    <div class="col-6 col-sm-4 col-md-3 col-lg mg-t-20 mg-md-t-0">
                        <h4 class="tx-normal tx-rubik mg-b-10">45</h4>
                        <div class="progress ht-2 mg-b-10">
                            <div class="progress-bar wd-45p bg-df-2" role="progressbar" aria-valuenow="45"
                                aria-valuemin="0" aria-valuemax="100"></div>
                        </div>
                        <h6 class="tx-uppercase tx-spacing-1 tx-semibold tx-10 tx-color-02 mg-b-2">Open Tickets
                        </h6>
                        <p class="tx-10 tx-color-03 mg-b-0"><span class="tx-medium tx-success">0.3% <i
                                    class="icon ion-md-arrow-down"></i></span> than yesterday</p>
                    </div><!-- col -->
                    <div class="col-6 col-sm-4 col-md-3 col-lg mg-t-20 mg-lg-t-0">
                        ...
                        <div class="progress ht-2 mg-b-10">
                            <div class="progress-bar wd-30p bg-df-2" role="progressbar" aria-valuenow="30"
                                aria-valuemin="0" aria-valuemax="100"></div>
                        </div>
                        <h6 class="tx-uppercase tx-spacing-1 tx-semibold tx-10 tx-color-02 mg-b-2">Unassigned
                        </h6>
                        <p class="tx-10 tx-color-03 mg-b-0"><span class="tx-medium tx-success">0.3% <i
                                    class="icon ion-md-arrow-down"></i></span> than yesterday</p>
                    </div><!-- col -->
                ...
                <div class="card">
                    ...
                    <div class="card-body pd-y-10">
                        <div class="d-flex align-items-baseline tx-rubik">
                            ...
                            <p class="tx-11 tx-color-03 mg-b-0"><span class="tx-medium tx-success">1.6% <i
                                        class="icon ion-md-arrow-up"></i></span></p>
                        </div>
                        <h6 class="tx-uppercase tx-spacing-1 tx-semibold tx-10 tx-color-02 mg-b-15">Performance
                            Score</h6>

                        <div class="progress bg-transparent op-7 ht-10 mg-b-15">
                            <div class="progress-bar bg-primary wd-50p" role="progressbar" aria-valuenow="30"
                                aria-valuemin="0" aria-valuemax="100"></div>
                            <div class="progress-bar bg-success wd-25p bd-l bd-white" role="progressbar"
                                aria-valuenow="15" aria-valuemin="0" aria-valuemax="100"></div>
                            <div class="progress-bar bg-warning wd-5p bd-l bd-white" role="progressbar"
                                aria-valuenow="5" aria-valuemin="0" aria-valuemax="100"></div>
                            <div class="progress-bar bg-pink wd-5p bd-l bd-white" role="progressbar"
                                aria-valuenow="5" aria-valuemin="0" aria-valuemax="100"></div>
                            <div class="progress-bar bg-teal wd-10p bd-l bd-white" role="progressbar"
                                aria-valuenow="10" aria-valuemin="0" aria-valuemax="100"></div>
                            <div class="progress-bar bg-purple wd-5p bd-l bd-white" role="progressbar"
                                aria-valuenow="10" aria-valuemin="0" aria-valuemax="100"></div>
                        </div>
                        ...
                        <table class="table-dashboard-two">
                            <tbody>
                                ...
                                <tr>
                                    <td>
                                        <div class="wd-12 ht-12 rounded-circle bd bd-3 bd-purple"></div>
                                    </td>
                        ...
                        <ul class="activity tx-13">
                            <li class="activity-item">
                                ...
                                <div class="activity-body">
                                    <p class="mg-b-2"><strong>Louise</strong> added a time entry to the ticket
                                        <a href="#" class="link-02"><strong>Sales Revenue</strong></a></p>
                            ...
                            <li class="activity-item">
                                ...
                                <div class="activity-body">
                                    <p class="mg-b-2"><strong>Kevin</strong> added new attachment to the ticket
                                        <a href="#" class="link-01"><strong>Software Bug Reporting</strong></a>
                                    </p>
                            ...
                            <li class="activity-item">
                                ...
                                <div class="activity-body">
                                    <p class="mg-b-2"><strong>Natalie</strong> reassigned ticket <a href="#"
                                            class="link-02"><strong>Problem installing software</strong></a> to
                                        <strong>Katherine</strong></p>
                            ...
                            <li class="activity-item">
                                ...
                                <div class="activity-body">
                                    <p class="mg-b-2"><strong>Katherine</strong> submitted new ticket <a
                                            href="#" class="link-02"><strong>Payment Method</strong></a></p>
                            ...
                            <li class="activity-item">
                                ...
                                <div class="activity-body">
                                    <p class="mg-b-2"><strong>Katherine</strong> changed settings to ticket
                                        category <a href="#" class="link-02"><strong>Payment &amp;
                                                Invoice</strong></a></p>
            ...
            <div class="col-md-6 mg-t-10">
                <div class="card">
                    ...
                    <div class="card-body pd-t-25">
                        <div class="media">
                            <div class="avatar"><img src="asset('admin/img/img15.jpg')" class="rounded-circle"
                                    alt=""></div>
                            <div class="media-body mg-l-15">
                                ...
                                <div class="progress ht-4 op-7 mg-b-5">
                                    <div class="progress-bar wd-85p" role="progressbar" aria-valuenow="85"
                                        aria-valuemin="0" aria-valuemax="100"></div>
                                </div>
                        ...
                        <div class="media mg-t-25">
                            <div class="avatar"><img src="asset('admin/img/img14.jpg')" class="rounded-circle"
                                    alt=""></div>
                            <div class="media-body mg-l-15">
                        ...
                        <div class="media mg-t-25">
                            <div class="avatar"><img src="asset('admin/img/img23.jpg')" class="rounded-circle"
                                    alt=""></div>
                            <div class="media-body mg-l-15">
                                <h6 class="tx-13 mg-b-2">Rolando Paloso</h6>
                                <p class="tx-color-03 tx-12 mg-b-10">Software Support</p>
                                <div class="progress ht-4 op-7 mg-b-5">
                                    <div class="progress-bar bg-indigo wd-45p" role="progressbar"
                        ...
                        <div class="media mg-t-20">
                            <div class="avatar"><img src="asset('admin/img/img22.jpg')" class="rounded-circle"
                                    alt=""></div>
                            <div class="media-body mg-l-15">
                                <h6 class="tx-13 mg-b-2">Dyanne Rose Aceron</h6>
                                <p class="tx-color-03 tx-12 mg-b-10">Sales Representative</p>
                                <div class="progress ht-4 op-7 mg-b-5">
                                    <div class="progress-bar bg-pink wd-40p" role="progressbar"
                ...
                <div class="card card-body">
                    <div class="media d-block d-sm-flex align-items-center">
                        ...
                        <div class="media-body mg-t-20 mg-sm-t-0 mg-sm-l-20">
                            ...
                            <p class="lh-4 tx-12 tx-color-03 mg-b-15">The average time taken to resolve
                                complaints.</p>
                            <h3 class="tx-spacing--1 mg-b-0">7m:32s <small class="tx-13 tx-color-03">/ Goal:
                                    8m:0s</small></h3>
                        </div><!-- media-body -->
                    </div><!-- media -->
                </div>
                ...
                <div class="card card-body">
                    <div class="media d-block d-sm-flex align-items-center">
                        ...
                        <div class="media-body mg-t-20 mg-sm-t-0 mg-sm-l-20">
                            ...
                            <p class="lh-4 tx-12 tx-color-03 mg-b-15">Measure how quickly support staff answer
                                incoming calls.</p>
                            <h3 class="tx-spacing--1 mg-b-0">0m:20s <small class="tx-13 tx-color-03">/ Goal:
                                    0m:10s</small></h3>
                        </div><!-- media-body -->
                    </div><!-- media -->
                </div>
            ...
            <div class="col-12 col-md-6 col-lg-12 mg-t-10">
                <div class="card">
                    <div class="card-header pd-t-20 pd-b-0 bd-b-0 d-flex justify-content-between">
                        ...
                        <a href="#" class="tx-13 link-03">This Month <i
                                class="icon ion-ios-arrow-down tx-12"></i></a>
                    </div><!-- card-header -->
                    <div class="card-body pd-0 pos-relative">
                        <div class="pos-absolute t-10 l-20 z-index-10">
                            <div class="d-flex align-items-baseline">
                                ...
                                <p class="tx-11 tx-color-03 mg-b-0"><span class="tx-medium tx-success">0.3% <i
                                            class="icon ion-md-arrow-down"></i></span> than last month</p>
                            </div>
                            <p class="tx-12 tx-color-03 wd-60p">The total number of complaints that have been
                                received.</p>
                        </div>
            ...
            <div class="col-12 col-md-6 col-lg-12 mg-t-10">
                <div class="card">
                    <div class="card-header pd-t-20 pd-b-0 bd-b-0">
                        ...
                        <p class="tx-12 tx-color-03 mg-b-0">Measures the quality or your support team’s efforts.
                        </p>
                    </div><!-- card-header -->
                    <div class="card-body pd-0">
                        ...
                        <div class="list-group list-group-flush tx-13">
                            ...
                            <div
                                class="list-group-item pd-y-5 pd-x-20 d-flex align-items-center bg-transparent">
...
@section('scripts')
<script src="{{asset('admin/lib/flot.curvedlines/curvedLines.js')}}"></script>
...
<script src="{{asset('admin/js/dashforge.sampledata.js')}}"></script>
