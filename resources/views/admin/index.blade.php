    ...
    <aside class="aside aside-fixed">
      ...
      <div class="aside-body">
        ...
        <ul class="nav nav-aside">
          ...
          <li class="nav-item"><a href="" class="nav-link"><i data-feather="layers"></i> <span>Components</span></a></li>
          <li class="nav-item"><a href="" class="nav-link"><i data-feather="box"></i> <span>Collections</span></a></li>
        </ul>
      </div>
    </aside>
              ...
              <div class="card ht-100p">
                ...
                <ul class="list-group list-group-flush tx-13">
                  ...
                  <li class="list-group-item d-flex pd-x-20">
                    <div class="avatar"><img src="{{ asset('admin/img/img23.jpg') }}" class="rounded-circle" alt=""></div>
                    <div class="pd-l-10">
                  ...
                  <li class="list-group-item d-flex pd-x-20">
                    <div class="avatar"><img src="{{ asset('admin/img/img16.jpg') }}" class="rounded-circle" alt=""></div>
                    <div class="pd-l-10">
