...
<div class="d-sm-flex align-items-center justify-content-between mg-b-20 mg-lg-b-25 mg-xl-b-30">
    ...
    <div>
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb breadcrumb-style1 mg-b-10">
                ...
                <li class="breadcrumb-item active" aria-current="page">Dados WebSite</li>
            </ol>
        </nav>
    ...
    <div class="d-none d-md-block">
        <button class="btn btn-sm pd-x-15 btn-primary btn-uppercase mg-l-5"><i data-feather="save"
                class="wd-10 mg-r-5"></i> Exportar</button>
    </div>
</div>
...
<div class="row row-xs">
    ...
    <div class="col-md-6 col-lg-5 mg-t-10">
        <div class="card">
            <div class="card-header pd-b-0 bd-b-0 pd-t-20 pd-lg-t-25 pd-l-20 pd-lg-l-25">
                <h6 class="mg-b-5">Aquisição</h6>
                <p class="tx-12 tx-color-03 mg-b-0">Te mostra dados de Taxa de rejeição e Sessões abertas no site,
                    baseados na origem dos visitantes.</p>
            </div><!-- card-header -->
                    ...
                    <div class="col-sm-5 col-md-12 col-lg-6 col-xl-5">
                        <div class="media">
                            ...
                            <div class="media-body mg-l-10">
                                ...
                                <p class="tx-10 tx-uppercase tx-medium tx-color-03 tx-spacing-1 tx-nowrap mg-b-0">Taxa
                                    de rejeição</p>
                            </div><!-- media-body -->
                        </div><!-- media -->
                    </div><!-- col -->
    ...
    <div class="col-sm-7 col-md-8 col-lg-4 col-xl mg-t-10">
        <div class="card">
            <div class="card-header">
                <h6 class="mg-b-0">Sessões por dispositivo</h6>
            </div><!-- card-header -->
            <div class="card-body">
                <div class="row row-xs">
                    <div class="col-4 col-lg">
                        <div class="d-flex align-items-baseline">
                            ...
                            <span
                                class="d-block tx-10 tx-uppercase tx-medium tx-spacing-1 tx-color-03 mg-l-7">Celular</span>
                        </div>
                    ...
                    <div class="col-4 col-lg">
                        <div class="d-flex align-items-baseline">
                            ...
                            <span
                                class="d-block tx-10 tx-uppercase tx-medium tx-spacing-1 tx-color-03 mg-l-7">Computador</span>
                        </div>
                    ...
                    <div class="col-4 col-lg">
                        <div class="d-flex align-items-baseline">
                            ...
                            <span
                                class="d-block tx-10 tx-uppercase tx-medium tx-spacing-1 tx-color-03 mg-l-7">Outros</span>
                        </div>
    ...
    <div class="col-sm-5 col-md-4 col-lg-3 mg-t-10">
        <div class="card">
            <div class="card-header">
                <h6 class="mg-b-0">Visualizações totais</h6>
            </div><!-- card-header -->
            <div class="card-body tx-center">
                <h4 class="tx-normal tx-rubik tx-40 tx-spacing--1 mg-b-0">29,931</h4>
                <p class="tx-12 tx-uppercase tx-semibold tx-spacing-1 tx-color-02">Visualizações da página</p>
                <p class="tx-12 tx-color-03 mg-b-0">Número total de páginas visualizadas. São contabilizadas as
                    visualizações totais do site. </p>
            </div><!-- card-body -->
            <div class="card-footer bd-t-0 pd-t-0">
                <button class="btn btn-sm btn-block btn-outline-primary btn-uppercase tx-spacing-1">Exportar</button>
            </div><!-- card-footer -->
        </div><!-- card -->
    </div>
        ...
        <div class="card">
            <div
                ...
                <div>
                    ...
                    <p class="tx-12 tx-color-03 mg-b-0">Audience to which the users belonged while on the current date
                        range.</p>
                </div>
                        ...
                        <div class="row">
                            <div class="col-sm-6 col-lg-12">
                                <div class="d-flex align-items-center justify-content-between mg-b-5">
                                    <h6 class="tx-uppercase tx-10 tx-spacing-1 tx-color-02 tx-semibold mg-b-0">New Users
                                    </h6>
                                ...
                                <div class="progress ht-4 mg-b-0 op-5">
                                    <div class="progress-bar bg-teal wd-65p" role="progressbar" aria-valuenow="65"
                                        aria-valuemin="0" aria-valuemax="100"></div>
                                </div>
                            </div>
                            <div class="col-sm-6 col-lg-12 mg-t-30 mg-sm-t-0 mg-lg-t-30">
                                <div class="d-flex align-items-center justify-content-between mg-b-5">
                                    <h6 class="tx-uppercase tx-10 tx-spacing-1 tx-color-02 tx-semibold mg-b-0">Page
                                        Views</h6>
                            ...
                            <div class="col-sm-6 col-lg-12 mg-t-30">
                                ...
                                <div class="progress ht-4 mg-b-0 op-5">
                                    <div class="progress-bar bg-pink wd-20p" role="progressbar" aria-valuenow="20"
                                        aria-valuemin="0" aria-valuemax="100"></div>
                                </div>
                            </div>
                            <div class="col-sm-6 col-lg-12 mg-t-30">
                                <div class="d-flex align-items-center justify-content-between mg-b-5">
                                    <h6 class="tx-uppercase tx-10 tx-spacing-1 tx-color-02 tx-semibold mg-b-0">Bounce
                                        Rate</h6>
    ...
    <div class="col-md-6 col-lg-4 col-xl-3 mg-t-10">
        <div class="card">
            ...
            <div class="card-footer pd-20">
                <div class="row">
                    <div class="col-6">
                        <p class="tx-10 tx-uppercase tx-medium tx-color-03 tx-spacing-1 tx-nowrap mg-b-5">Acesso direto
                        </p>
                    ...
                    <div class="col-6 mg-t-20">
                        <p class="tx-10 tx-uppercase tx-medium tx-color-03 tx-spacing-1 mg-b-5">Referência</p>
                        <div class="d-flex align-items-center">
    ...
    <div class="col-lg-6 mg-t-10">
        <div class="card">
            <div class="card-header d-flex align-items-start justify-content-between">
                <h6 class="lh-5 mg-b-0">Quais páginas seus usuários visitam? </h6>
            ...
            <div class="card-body pd-y-15 pd-x-10">
                <div class="table-responsive">
                    <table class="table table-borderless table-sm tx-13 tx-nowrap mg-b-0">
                        ...
                        <tbody>
                            <tr>
                                <td class="align-middle text-center"><a href="#"><i data-feather="external-link"
                            ...
                            <tr>
                                ...
                                <td class="align-middle text-right">
                                    <div class="wd-150 d-inline-block">
                                        <div class="progress ht-4 mg-b-0">
                                            <div class="progress-bar bg-warning wd-45p" role="progressbar"
                    ...
                    <table class="table table-borderless table-sm tx-13 tx-nowrap mg-b-0">
                        <thead>
                            <tr class="tx-10 tx-spacing-1 tx-color-03 tx-uppercase">
                                ...
                                <th class="text-right">Taxa de Rejeição</th>
