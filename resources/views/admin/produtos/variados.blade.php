        ...
        <div class="filemgr-sidebar">
            ...
            <div class="filemgr-sidebar-header">
                ...
                <div class="dropdown dropdown-icon flex-fill mg-l-10">
                    ...
                    <div class="dropdown-menu tx-13">
                        <a href="#" class="dropdown-item"><i data-feather="box"></i><span>Produto</span></a>
                        <a href="#" class="dropdown-item"><i data-feather="folder"></i><span>Categoria</span></a>
                    </div>
                    <!-- dropdown-menu -->
                </div>
                <!-- dropdown -->
            ...
            <div class="filemgr-sidebar-body">
                <div class="pd-t-20 pd-b-10 pd-x-10">
                    <label class="tx-sans tx-uppercase tx-medium tx-10 tx-spacing-1 tx-color-03 pd-l-10">No pote</label>
                    <nav class="nav nav-sidebar tx-13">
                        <a href="#" class="nav-link active"><i data-feather="box"></i> <span>Bolo de Pote</span></a>
                        <a href="#" class="nav-link"><i data-feather="box"></i> <span>Torta de Pote</span></a>
                        <a href="#" class="nav-link"><i data-feather="box"></i> <span>Torta Holandesa</span></a>
                        <a href="#" class="nav-link"><i data-feather="box"></i> <span>Pavê de Pote</span></a>
                    </nav>
                </div>

                <div class="pd-t-20 pd-b-10 pd-x-10">
                    <label class="tx-sans tx-uppercase tx-medium tx-10 tx-spacing-1 tx-color-03 pd-l-10">Ajoms</label>
                    <nav class="nav nav-sidebar tx-13">
                        <a href="#" class="nav-link"><i data-feather="box"></i> <span>Pavê</span></a>
                        <a href="#" class="nav-link"><i data-feather="box"></i> <span>Trufas</span></a>
                        <a href="#" class="nav-link"><i data-feather="box"></i> <span>Docinhos</span></a>
                    </nav>
                </div>

                <div class="pd-t-20 pd-b-10 pd-x-10">
                    <label class="tx-sans tx-uppercase tx-medium tx-10 tx-spacing-1 tx-color-03 pd-l-10">Festinha</label>
                    <nav class="nav nav-sidebar tx-13">
                        <a href="#" class="nav-link"><i data-feather="box"></i> <span>Trufas</span></a>
                        <a href="#" class="nav-link"><i data-feather="box"></i> <span>Docinhos</span></a>
                    </nav>
                            ...
                            <div class="card card-file">
                                ...
                                <div class="card-body">
                                    ...
                                    <select class="custom-select">
                                        ...
                                        <option value="1">De Pote</option>
                                        <option value="2">Linha Ajoms</option>
                                        <option value="3">Festinha</option>
                                    </select>
                                </div>

                                <div class="card-body">
                                    <h6><a class="link-02 mg-b-10">Titulo</a></h6>
                                    <input type="text" class="form-control" value="Esse é o titulo do produto" placeholder=" Insira o Titulo">
                                </div>

                                <div class="card-body">
                                    <h6><a href="#" class="link-02 mg-b-10">SubTitulo</a></h6>
                                    <input type="text" class="form-control" value="Esse é o subtitulo do produto" placeholder=" Insira o SubTitulo">
                                </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="input-group">
                                        <select class="form-control select2" multiple="multiple">
                                            ...
                                            <option value="Firefox" selected>100ml</option>
                                            <option value="Chrome" selected>200ml</option>
                                            <option value="Safari">300ml</option>
                                            <option value="Opera">500ml</option>
                                        </select>
                                        <div class="input-group-append">
                                            <button class="btn btn-outline-light" data-toggle="modal" data-target="#modalInsertTags" type="button" id="button-addon2">Add
                                                Tamanho</button>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="input-group">
                                        <select class="form-control select2" multiple="multiple">
                                            <option label="Choose one"></option>
                                            <option value="Firefox" selected>Chocolate</option>
                                            <option value="Chrome" selected>Prestigio</option>
                                            <option value="Safari">Morango</option>
                                            <option value="Opera">Abacaxi</option>
                                        </select>
                                        <div class="input-group-append">
                                            <button class="btn btn-outline-light" data-toggle="modal" data-target="#modalInsertTags" type="button" id="button-addon2">Add
                                                Sabor</button>
                                ...
                                <div class="card-footer mg-t-20"><span class="d-none d-sm-inline">Última modificação:
                    ...
                    <div class="row row-xs">
                        <div class="col-6 col-sm-4 col-md-3 col-xl mg-t-10 mg-sm-t-0">
                            <div class="card card-file">
                                ...
                                <div class="tx-11 tx-color-04 mg-t-10"><span class="d-none d-sm-inline">Última
                                        atualização: </span>6 horas atrás</div>
                            </div>
                        </div>
                        <!-- col -->
                        <div class="col-6 col-sm-4 col-md-3 col-xl mg-t-10 mg-sm-t-0">
