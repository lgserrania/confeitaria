        ...
        <div class="filemgr-sidebar">
            ...
            <div class="filemgr-sidebar-body" style="position: initial;">
                <div class="pd-t-20 pd-b-10 pd-x-10">
                    <label class="tx-sans tx-uppercase tx-medium tx-10 tx-spacing-1 tx-color-03 pd-l-10">Minhas
                        páginas</label>
        ...
        <div class="filemgr-content">
                ...
                <nav class="nav d-none d-sm-flex mg-r-auto mg-l-15">
                    ...
                    <div class="dropdown dropdown-icon flex-fill">
                        ...
                        <div class="dropdown-menu tx-13">
                            ...
                            <a href="#modalViewDetails" data-toggle="modal" class="dropdown-item details"><i
                                    data-feather="file"></i><span>Arquivo</span></a>
                        </div>
                    </div>
            ...
            <div class="filemgr-content-body">
                <div class="pd-20 pd-lg-25 pd-xl-30">
                    ...
                    <label
                        class="d-block tx-medium tx-10 tx-uppercase tx-sans tx-spacing-1 tx-color-03 mg-b-15">Informações
                        da Página</label>
                        ...
                        <div class="col-6 col-sm-4 col-md-3 col-xl">
                            <div class="card card-file">
                                ...
                                <div class="card-body">
                                    ...
                                    <input type="text" class="form-control" value="Esse é o titulo da pagina"
                                        placeholder=" Insira o Titulo">
                                </div>

                                <div class="card-body">
                                    <h6><a href="#" class="link-02 mg-b-10">SubTitulo</a></h6>
                                    <input type="text" class="form-control" value="Esse é o subtitulo da pagina"
                                ...
                                <div class="card-body">
                                    ...
                                    <div id="editor" class="ht-200">
                                        <strong>Quill</strong> is a free, <a href="#">open source</a> WYSIWYG editor
                                        built for the modern web. With its modular architecture and expressive API, it
                                    ...
                                    <div class="input-group">
                                        ...
                                        <div class="input-group-append">
                                            <button class="btn btn-outline-light" data-toggle="modal"
                                                data-target="#modalInsertTags" type="button" id="button-addon2">Add
                                                Tags</button>
                                        </div>
                                    </div>
                    ...
                    <label
                        class="d-block tx-medium tx-10 tx-uppercase tx-sans tx-spacing-1 tx-color-03 mg-b-15">Arquivos
                        Relacionados</label>
                    <div class="row row-xs">
                        <div class="col-6 col-sm-4 col-md-3 col-xl mg-t-10 mg-sm-t-0">
                            <div class="card card-file">
                                ...
                                <div class="card-file-thumb tx-indigo">
                                    <img src="{{asset('admin/img/img37.jpg')}}" class="img-fit-cover" alt="Responsive image">
                                </div>
                                <div class="card-body">
                                    <h6><a href="#modalViewDetails" data-toggle="modal"
                                            class="link-02">IMG_063037.jpg</a></h6>
                                    <span>4.1mb</span>
                                </div>
                        ...
                        <div class="col-6 col-sm-4 col-md-3 col-xl mg-t-10 mg-sm-t-0">
                            <div class="card card-file">
                                @include('admin.includes.dropdown-image-icon')
                                <div class="card-file-thumb tx-indigo">
                                    <img src="{{asset('admin/img/img38.jpg')}}" class="img-fit-cover" alt="Responsive image">
                                </div>
                                <div class="card-body">
                                    <h6><a href="#modalViewDetails" data-toggle="modal"
                                            class="link-02">IMG_063037.jpg</a></h6>
                        ...
                        <div class="col-6 col-sm-4 col-md-3 col-xl">
                            <div class="card card-file">
                                ...
                                <div class="card-body">
                                    <h6><a href="#modalViewDetails" data-toggle="modal" class="link-02">Medical
                                            Certificate.pdf</a></h6>
                                    <span>10.45kb</span>
                                </div>
                                <div class="card-footer"><span class="d-none d-sm-inline">Última atualização: </span>2
                                    horas atrás</div>
                            </div>
                        </div><!-- col -->
                        <div class="col-6 col-sm-4 col-md-3 col-xl">
                            <div class="card card-file">
                                ...
                                <div class="card-body">
                                    <h6><a href="#modalViewDetails" data-toggle="modal" class="link-02">Job
                                            Contract.docx</a></h6>
                                    <span>22.67kb</span>
                                </div>
                                <div class="card-footer"><span class="d-none d-sm-inline">Última atualização: </span>5
                                    horas atrás</div>
                            </div>
                        </div><!-- col -->
                    </div><!-- row -->
