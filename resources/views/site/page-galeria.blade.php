    ...
    <div id="content">
      ...
      <section id="gallery" class="section section-gallery cover">
        ...
        <div class="gallery-carousel inner-controls">
          <div class="slide">
            <div class="bg-image bg-parallax"><img src="assets/img/gallery/gallery01.jpg" alt=""></div>
          </div>
          <div class="slide">
            <div class="bg-image bg-parallax"><img src="assets/img/gallery/gallery02.jpg" alt=""></div>
          </div>
          <div class="slide">
            <div class="bg-image bg-parallax"><img src="assets/img/gallery/gallery03.jpg" alt=""></div>
          </div>
          <div class="slide">
            <div class="bg-image bg-parallax"><img src="assets/img/gallery/gallery04.jpg" alt=""></div>
          </div>
          <div class="slide">
            <div class="bg-image bg-parallax"><img src="assets/img/gallery/gallery05.jpg" alt=""></div>
          </div>
        </div>
