        ...
        <div class="container">
          <div class="row">
            <div class="col-lg-8 push-lg-4">
              <h1 class="mb-0">Fique por dentro</h1>
              <h4 class="text-muted mb-0">Siga nosso blog e veja sempre as novidades!</h4>
            </div>
          </div>
        </div>
      </div>
            ...
            <div class="col-lg-10 push-lg-1">
              ...
              <article class="post post-wide animated" data-animation="fadeIn">
                ...
                <div class="post-content">
                  ...
                  <h4><a href="page-blog-post.php">Páscoa para todos os gostos</a></h4>
